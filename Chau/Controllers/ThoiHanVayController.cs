...
namespace Chau.Controllers
{
    public class ThoiHanVayController : Controller
    {
        ...
        {
            var lisofdata = _context.ThoiHanVay.ToList();
        ...
        public ActionResult Create(Models.ThoiHanVay model) // yeu cau POST tu form tao moi va them mot bang ghi moi vao NhomHangs
        {
            // Chuyển đổi định dạng ngày từ MM/dd/yyyy sang dd/MM/yyyy


            _context.ThoiHanVay.Add(model); // nhan tham so( model) la doi tuong NhomHang chua thong tin nguoi dung nhap vao form va them vao NhomHangs
        ...
        public ActionResult Delete(string id)
        {
            ...
            var item = _context.ThoiHanVay.Find(id);
        ...
        public ActionResult DeleteConfirmed(string id)
        {
            ...
            var model = _context.ThoiHanVay.Find(id.ToString());
            if (model == null)
            {
                return HttpNotFound();
            }
            // Xóa đối tượng
            _context.ThoiHanVay.Remove(model);
