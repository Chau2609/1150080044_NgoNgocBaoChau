...
namespace Chau.Controllers
{
    public class DMChiNhanhController : Controller
    {
        ...
        public ActionResult Create(Models.DMChiNhanh model) // yeu cau POST tu form tao moi va them mot bang ghi moi vao NhomHangs
        {
            // Chuyển đổi định dạng ngày từ MM/dd/yyyy sang dd/MM/yyyy


            _context.DMChiNhanh.Add(model); // nhan tham so( model) la doi tuong NhomHang chua thong tin nguoi dung nhap vao form va them vao NhomHangs
        ...
        public ActionResult Delete(string id)
        {
            ...
            var item = _context.DMChiNhanh.Find(id);
        ...
        public ActionResult DeleteConfirmed(string id)
        {
            ...
            var model = _context.DMChiNhanh.Find(id.ToString());
            if (model == null)
            {
                return HttpNotFound();
            }
            // Xóa đối tượng
            _context.DMChiNhanh.Remove(model);
